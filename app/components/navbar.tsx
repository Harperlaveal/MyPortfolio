                  ...
                  <Link
                    ...
                    className={`${
                      pathname === "/"
                        ...
                        : "border-transparent text-gray-500 hover:text-black dark:text-gray-300 dark:hover:text-white inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"
                    }`}
                  >
                    Home
                  </Link>
